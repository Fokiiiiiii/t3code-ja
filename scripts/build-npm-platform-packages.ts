...
export function npmPlatformPackageReadme(platformKey: CliArchivePlatformKey): string {
  return [
    ...
    "```",
    "",
    "Source and documentation: https://github.com/Fokiiiiiii/t3code-ja",
    "",
  ].join("\n");
}
...
try {
  ...
  process.stderr.write(
    [
      ...
      "The desktop app and release archives are at https://github.com/Fokiiiiiii/t3code-ja/releases",
      "",
    ].join("\\n"),
  );
  process.exit(1);
