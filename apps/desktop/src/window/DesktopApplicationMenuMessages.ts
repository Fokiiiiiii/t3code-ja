...
const messages = {
  ...
  ja: {
    ...
    minimize: "最小化",
    zoomWindow: "拡大／縮小",
    bringAllToFront: "すべてを最前面に移動",
    actualSize: "実際のサイズ",
    zoomIn: "拡大",
    zoomOut: "縮小",
    ok: "OK",
    upToDateTitle: "最新の状態です",
    upToDateMessage: (version) => `T3 Code ${version} は最新バージョンです。`,
    updateCheckFailedTitle: "アップデートの確認に失敗",
    updateCheckFailedMessage: "アップデートを確認できませんでした。",
    unknownUpdateError: "不明なエラーが発生しました。後でもう一度お試しください。",
    updatesUnavailableTitle: "アップデートを利用できません",
    updatesUnavailableMessage: "現在、自動アップデートを利用できません。",
  },
